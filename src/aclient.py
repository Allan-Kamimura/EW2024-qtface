...
async def receive_and_process_control(websocket, message_received_callback):
    while True:
        ...
        message_received_callback(control_data)
...
async def main():
    async with websockets.connect('ws://localhost:8000') as websocket:
        ...
        control_task = asyncio.create_task(receive_and_process_control(websocket, print_received_message))
